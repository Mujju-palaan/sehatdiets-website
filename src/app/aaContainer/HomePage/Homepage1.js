"use client";
import homestyle from "./Homepage1.module.css";
    ...
    <>
      <div>
        ...
        <div className={homestyle.main}>
          ...
          >
            <div className={homestyle.conatiner}>
              <p>GET STARTED ON THE PATH TO HEALTH ! </p>
              <h2>LIVING YOUR BEST LIFE</h2>
              <div>
                <span className={homestyle.hidden}>
        ...
        <div className={homestyle.part1}>
          ...
          <div>
            <img className={homestyle.vector} src="./img3.png"></img>
          </div>
        </div>
