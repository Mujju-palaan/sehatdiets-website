    ...
    <div>
      ...
      >
        <div className="challenge">
          <h1 className="h2">Change your life in the next </h1>
          <h1 className="h2" style={{ color: "green" }}>
            90 days of Practice
          </h1>
          <p style={{ color: "grey" }}>
          ...
          <div className="contentbox">
            <div className="contentbox">
              <div style={{ margin: "2rem", marginTop: 0 }}>
                <h2 className="h3">Personalized Nutrition Plan</h2>
            ...
            <div className="contentbox">
              <div style={{ margin: "2rem", marginTop: 0 }}>
                <h2 className="h3">Personalized Exercise Plan</h2>
